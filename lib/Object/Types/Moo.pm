...
sub _create (@args) {
    return Object::Types::Moo::Factory->create(@args);
}
...
Object::Types::Moo - Types::Standard-like functions with better error reporting

=head1 SYNOPSIS

    use Object::Types::Moo qw(:all);
