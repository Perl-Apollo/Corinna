...
sub _create (@args) {
    return Object::Types::Moose::Factory->create(@args);
}
...
Object::Types::Moose - Types::Standard-like functions with better error reporting

=head1 SYNOPSIS

    use Object::Types::Moose qw(:all);
