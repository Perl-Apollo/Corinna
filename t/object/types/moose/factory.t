...
use Test::Most;
use Storable 'dclone';
use Object::Types::Moose::Factory;
$Object::Types::Moose::Factory::Test::Mode = 1;

subtest 'Any' => sub {
    my $Any = Object::Types::Moose::Concrete::Any->new;
    ok $Any->validate(undef), 'Any() always passes';
};

subtest 'Int' => sub {
    my $Int = Object::Types::Moose::Concrete::Int->new;
    ok $Int->validate(37), 'Int() should validate ints';
    ok !$Int->validate(32.8), '... but not non-ints';
};

subtest 'Num' => sub {
    my $Num = Object::Types::Moose::Concrete::Num->new;
...
subtest 'Str' => sub {
    my $Str = Object::Types::Moose::Concrete::Str->new;
...
subtest 'Regex' => sub {
    my $Regex = Object::Types::Moose::Concrete::Regex->new( regex => qr/ab*c/ );
    ...
    $Regex = Object::Types::Moose::Concrete::Regex->new( regex => qr/x/ );
    ok !$Regex->validate( [] ), 'Regexes can never validate references';
};

subtest 'Enum' => sub {
    my $Enum =
      Object::Types::Moose::Concrete::Enum->new( elements => [ 1, 2, 'Ovid' ] );
    ...
    my $Enum_with_types = Object::Types::Moose::Concrete::Enum->new(
        elements => [ 'Ovid', Object::Types::Moose::Concrete::Int->new ] );
...
subtest 'ArrayRef' => sub {
    my $ArrayRef = Object::Types::Moose::Concrete::ArrayRef->new;
...
'... but they will not validate against things that are not array references';
    ...
    my $ArrayRef_of_ints = Object::Types::Moose::Concrete::ArrayRef->new(
        contains => Object::Types::Moose::Concrete::Int->new );
...
subtest 'HashRef' => sub {
    my $HashRef = Object::Types::Moose::Concrete::HashRef->new;
    ...
    my $HashRef_of_ints = Object::Types::Moose::Concrete::HashRef->new(
        contains => Object::Types::Moose::Concrete::Int->new );
...
subtest 'Maybe' => sub {
    my $Maybe = Object::Types::Moose::Concrete::Maybe->new(
        contains => Object::Types::Moose::Concrete::Str->new );
...
subtest 'Optional' => sub {
    my $Optional = Object::Types::Moose::Concrete::Optional->new(
        contains => Object::Types::Moose::Concrete::Str->new );
...
subtest 'Coerce' => sub {
    my $true_false =
      Object::Types::Moose::Concrete::Enum->new( elements => [qw/true false/] );
    my $Coerce = Object::Types::Moose::Concrete::Coerce->new(
        contains => $true_false,
        via      => sub { $_[0] eq 'true' ? 1 : 0 }
    );
    my $true = 'true';
