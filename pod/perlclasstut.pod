...
Now that we know how to contruct a basic object, we probably want to do things
with it. To do that, we write methods. Methods use the C<method> keyword
instead of C<sub>. They also take argument lists. Let's look at an
